...
class DBUser(Base):
    ...
    invested_in = relationship('DBHouse', secondary=user_house_association, back_populates='investors')
...
class DBHouse(Base):
    ...
    investors = relationship('DBUser', secondary=user_house_association, back_populates='invested_in')
